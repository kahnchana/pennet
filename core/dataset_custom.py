...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, data_args, split='train', level=None, debug=None):
        ...
        # self.data = torchvision.datasets.ImageFolder("/home/kanchana/Downloads/ref_repos/context_encoder_pytorch/data/Paris/train")
        self.data = torchvision.datasets.ImageFolder("/home/kanchana/Downloads/public_datasets/facade_test/test_pretrained")
